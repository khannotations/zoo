 ...
 * If parameters are used, the first one is the system command to execute, the others are its system command parameters. 
...
public final class JavaSystemCaller 
{
  ...
  /**
   * Builds a Execution Environment for Windows. 
  ...
  {
    /**
     * Builds an execution environment for a Windows system command to be played. 
